 ...
 */
public class ContaCorrente_novo extends javax.swing.JFrame {

    /**
     * Creates new form ContaCorrente
     */
    public ContaCorrente_novo() {
        initComponents();
}
    String operacaoAtivaGlobal = "Nenhum";
    public ContaCorrente_novo (String operacaoAtiva){
        initComponents();
...
//CADASTRAR DADOS
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ContaCorrente_novo.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ContaCorrente_novo().setVisible(true);
            }
        });
    }
