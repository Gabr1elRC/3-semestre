...
/**
*
* @author Wendel Augusto
*/
public class Agencia_novo extends javax.swing.JFrame {
    ...
    public Agencia_novo (String operacaoAtiva){
        initComponents();
    ...
    if (operacaoAtivaGlobal.equals(operacao)){
        ...
        dados_Agencias.setNumAgencia(jTextField1.getText());
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        ...
        jTextField4.setText(agencia_tela.getEndereco());
        jTextField5.setText(agencia_tela.getNumero());
        jTextField6.setText(agencia_tela.getComplemento());
        jTextField7.setText(agencia_tela.getBairro());
        jTextField8.setText(agencia_tela.getCidade());
        jTextField9.setText(agencia_tela.getUF());
        jTextField10.setText(agencia_tela.getCEP());
        jTextField11.setText(agencia_tela.getTelefone());
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Agencia_novo.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Agencia_novo().setVisible(true);
            }
        });
    }
