 ...
 */
public class ExtratoMovimentacao_novo extends javax.swing.JFrame {
 
    /**
     * Creates new form ExtratoMovimentacao
     */
    public ExtratoMovimentacao_novo() {
        initComponents();
    }
        String operacaoAtivaGlobal = "Nenhum";
    public ExtratoMovimentacao_novo (String operacaoAtiva){
        initComponents();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ExtratoMovimentacao_novo.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ExtratoMovimentacao_novo().setVisible(true);
            }
        });
    }
